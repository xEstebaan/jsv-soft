...
def ver_empleado(empleado_id):
    ...
    credencial_pin = (Credencial.query
                     .join(TipoCredencial)
    ...
    return render_template('admin/ver_empleado.html',
                          empleado=empleado,
                          persona=persona,
                          cargo=cargo,
...
def editar_empleado(empleado_id):
    ...
    if request.method == 'POST':
        try:
            ...
            if not primer_nombre or not primer_apellido or not documento or not correo or not cargo_id or not fecha_contratacion:
                flash('Todos los campos marcados con * son obligatorios', 'error')
